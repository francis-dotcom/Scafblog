...
<div className="prerequisites-grid">
 <div className="prereq-card technical">
  ...
  <p>
    AWS Account with admin access, Terraform v1.0+ installed, kubectl and eksctl CLI tools, Docker Desktop running, and basic Kubernetes knowledge.
  </p>
 </div>
...
<div className="prereq-card time">
  ...
  <p>
    <strong>Total:</strong> 8–12 hours, <strong>Phase 1–2:</strong> 3–4 hours
    (Infrastructure), <strong>Phase 3–4:</strong> 3–4 hours (Services),{" "}
...
<p className="arch-stats">
  <strong>3</strong> AWS Regions, <strong>40+</strong> Microservices,{" "}
  <strong>15min</strong> RTO Target, <strong>99.99%</strong> Availability
</p>
...
<div className="strategy-region primary">
  ...
  <p>
    <strong>Role:</strong> Main trading operations and customer-facing services
  </p>
  <p>
